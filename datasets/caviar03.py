...
def loadcameras():
    ...
    #cam1_g1.video.readvideo(variables.current_video_path + '/Meet_WalkTogether2.mpg')
    cam1_g1.video.readvideo(variables.current_video_path + '/Meet_WalkTogether2.avi')
