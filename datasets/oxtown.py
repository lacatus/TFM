...
def setglobalvariables():
    ...
    variables.current_dataset_path = variables.datasets_path + '/oxtown'
    variables.current_video_path = variables.current_dataset_path + '/video'
...
def loadcameras():
    ...
    cam1_g1.video.readbg(
        variables.current_dataset_path + '/background/camera001.jpg')
